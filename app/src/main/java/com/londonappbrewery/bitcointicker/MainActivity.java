...
public class MainActivity extends AppCompatActivity {
    ...
    private final String TAG_APP = "Bitcoin";
    // Member Variables:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Log.d(TAG_APP, ""+ currency);
                String newUrl = BASE_URL + "indices/global/ticker/"+"BTC"+currency;
                letsDoSomeNetworking(newUrl);
            }

            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
                Log.d(TAG_APP, "Nothing selected");
            }
        });
    ...
    private void letsDoSomeNetworking(String url) {
        ...
        client.get(this, url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                Log.d(TAG_APP, response.toString());
                updateUI(response);
            }
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable e, JSONObject response) {
                ...
                Log.d(TAG_APP, "Request fail! Status code: " + statusCode);
                Log.d(TAG_APP, "Fail response: " + response);
                Log.e(TAG_APP, e.toString());
